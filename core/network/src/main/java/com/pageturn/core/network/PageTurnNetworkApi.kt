...
class FakePageTurnNetworkApi : PageTurnNetworkApi {
    private val books = listOf(
        Book(
            ...
            coverUrl = "https://example.com/covers/sherlock.jpg",
        ...
        Book(
            ...
            coverUrl = "https://example.com/covers/mobydick.jpg",
            progressPercent = 0.12f,
            totalPages = 600,
            currentPage = 72,
            description = "The sailor Ishmael's narrative of the obsessive quest of Ahab, captain of the whaling ship Pequod."
        ),
        Book(
            id = "5",
            title = "War and Peace",
            author = "Leo Tolstoy",
            coverUrl = "https://example.com/covers/warpeace.jpg",
